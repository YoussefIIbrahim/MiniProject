...
.controller('managementCtrl', function(User, $timeout, $location, $route, $scope) {
    var app = this;
    ...
    app.addWork = function(assign) {
      ...
      User.pushWork(app.assign).then(function(data) {
    ...
    function getUsers() {
        ...
        User.getUsers().then(function(data) {
            ...
            if (data.data.success) {
                ...
                if (data.data.permission === 'admin' || data.data.permission === 'student') {
                    app.users = data.data.users.content; // Assign users from database to variable
                    app.loading = false; // Stop loading icon
                    app.accessDenied = false; // Show table
                    // Check if logged in user is an admin or student
...
.controller('editCtrl', function($scope, $routeParams, User, $timeout) {
    ...
    app.permissionsPhase = function() {
        ...
        app.disablestudent = false; // Disable buttons while processing
        ...
        } else if ($scope.newPermission === 'student') {
            app.disablestudent = true; // Disable 'student' button
    ...
    app.updatePermissions = function(newPermission) {
        ...
        app.disablestudent = true; // Disable button while processing
            ...
            if (data.data.success) {
                ...
                $timeout(function() {
                    ...
                    if (newPermission === 'user') {
                        ...
                        app.disablestudent = false; // Unlock the 'student' button
                        app.disableAdmin = false; // Unlock the 'admin' button
                    } else if (newPermission === 'student') {
                        app.disablestudent = true; // Lock the 'student' button
